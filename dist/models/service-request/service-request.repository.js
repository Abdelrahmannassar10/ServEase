...
const service_request_schema_1 = require("./service-request.schema");
let ServiceRequestRepository = class ServiceRequestRepository extends abstract_repository_1.AbstractRepository {
    serviceRequestModel;
    constructor(serviceRequestModel) {
    ...
    async findDuplicateRequest(customerId, providerId, dateNeeded, startTime) {
